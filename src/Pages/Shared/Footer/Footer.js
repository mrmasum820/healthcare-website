                    ...
                    <Row>
                        <Col md={3} sm={6} xs={12} className='text-start column-gap-responsive'>
                            ...
                            <div className="foot-detail-1">
                                <p>MediCare Health Care acquired permission to start a Nursing College in 1998.
                                    Since 1999 United College of Nursing has been functioning with students
                        ...
                        <Col md={3} sm={6} xs={12} className='text-start column-gap-responsive'>
                            ...
                            <ul className="foot-detail-4">
                                ...
                                <li>{envIcon} info@medicare.com</li>
                                <li>{phnIcon} +123 - 965 - 7645</li>
                            </ul>
                        </Col>
                    </Row>
                </Container>
